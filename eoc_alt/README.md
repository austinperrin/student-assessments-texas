# STAAR Alt 2 EOC Fixed-Width Mappings

This folder contains year-specific fixed-width mapping files for STAAR Alternate 2 End-of-Course reporting student data files.

Each JSON file is intended to represent one school year's published STAAR Alt 2 EOC data file layout from the Texas Education Agency.
...
- `2016-staar-alt2-eoc-fixed-width-mapping.json`
...
These mappings are curated against the corresponding PDF layout for each year in the [docs](../docs) folder and the official TEA/Texas Assessments PDF URLs stored in each file's `metadata`.
