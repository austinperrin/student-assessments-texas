# STAAR Interim AI Agent Guide

This file guides AI agents working inside `assessments/tea/staar/interim/`.
...
- treat `docs/source-archives/tea/2023/2023-crs-layout-interim-boy.pdf` as interim-related source material
