...
1. Obtain the official TEA consolidated accountability online source for that year.
...
```powershell
Get-Content 'assessments/tea/staar/consolidated_accountability/2025-staar-consolidated-accountability-fixed-width-mapping.json' | ConvertFrom-Json | Out-Null
```

For all files in this family:

```powershell
Get-ChildItem assessments/tea/staar/consolidated_accountability -Filter '*-staar-consolidated-accountability-fixed-width-mapping.json' |
  ForEach-Object {
